...
<?php
    ...
    if(isset($_POST['login'])){
        ...
        $uname_query = "select * from signup where uname = '$username'";
        ...
        if($uname_cnt == 1){
            ...
            if($pass_match){
                ...
                $_SESSION['sno'] = $arr['sno'];
                if(isset($_POST['remember'])){
                    setcookie('uname', $username, time() + (86400 * 7));
        ...
        ?>
            ...
            <div class="form">
                ...
                <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST" autocomplete = "off">
                    ...
                    <label class="remember"><input type="checkbox" name = "remember">Remember Me(7 days)</label>
                    ...
                    <p><a href="./register.php">Not a Member<i class='fas fa-question'></i> Sign UP</a></p>
                </form>
            </div>
